<template>
  <footer class="mp-pc-invoice-make-up-list-page-footer-comp-wrap">
    <Count
      ...
      >
      <el-checkbox v-model="localCheckAll" class="check-all" :indeterminate="indeterminate" :disabled="disabled" title="跨分页选中当前条件下全部可开票订单">全选</el-checkbox>
      <!-- <ShowProductBtn title="选中全部订单" :disabled="disabled" :isActive="localCheckAll" @click.native="handleClick" /> -->
      <template #right>
        <!-- <div class="btns"> -->
          <!-- <el-tooltip effect="light" content="选中全部可开票订单" popper-class="in-tip" placement="top-start" :enterable="false"> -->
            <!-- <span class="blue-span" @click="handleClick(true)" title="选中全部可开票订单" :class="{disabled: disabled}">选中全部</span> -->
          <!-- </el-tooltip> -->
          <!-- <el-tooltip effect="light" content="取消全部订单选中状态" popper-class="in-tip" placement="top-start" :enterable="false"> -->
            <!-- <span class="blue-span" @click="handleClick(false)" title="取消全部选中订单状态" :class="{disabled: disabled}">取消全部选中</span> -->
          <!-- </el-tooltip> -->
        <!-- </div> -->
...
export default {
  ...
  computed: {
    ...
    indeterminate() {
      if (!this.localCheckAll && this.InvoiceMakeupOrderNumber > 0) {
