...
let proxyUrl = 'http://219.157.151.220:8050';
// let proxyUrl = 'http://erp.ybz888.com/';

// 测试开发环境：调用92接口
if (process.env.VUE_APP_BASE_URL && process.env.VUE_APP_BASE_URL === 'test-development') proxyUrl = 'http://219.157.151.220:8050';
// 测试开发环境：调用正式接口
